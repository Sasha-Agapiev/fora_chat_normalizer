...
#             'bratislava', 'krakow', 'warsaw', 'gdansk', 'tallinn', 'riga', 'vilnius', 'delft'
#         }
...
#         """Extract cities, hotels, and restaurants using spaCy NER + pattern matching"""
#         try:
#             entities = []
...
#             logger.info(f"Extracted {len(unique_entities)} entities: {[f'{e.type.value}:{e.value}' for e in unique_entities]}")
